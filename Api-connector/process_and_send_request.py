...
def forward_to_target_server(payload):
    ...
    """
    try:
        target_url = 'https://cf7d-2401-4900-9014-a648-a4d6-e9a3-2620-2b67.ngrok-free.app/receive-partial-application'  # Use httpbin for testing
...
def receive_kyc_details():
    ...
    try:
        ...
        # Forward to target server
        target_url = 'https://cf7d-2401-4900-9014-a648-a4d6-e9a3-2620-2b67.ngrok-free.app/onboard-kyc'
